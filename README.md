...
- Il pulsante con l’orologio nella barra di ricerca apre la cronologia locale del partecipante: i punti partono dal più vecchio e crescono secondo la data di creazione; modificarne uno non ne cambia la posizione. Il riordino manuale resta disponibile e viene rispettato nell’export. Ogni punto può inoltre essere etichettato, rivisto sulla mappa, inviato nuovamente come foto o eliminato. **Condividi questa lista** genera un pacchetto `*.catpoints.json` legato esplicitamente a questo sito: contiene URL e istruzioni di importazione, proprietario originale, persona che sta condividendo e catena dei passaggi. **Importa punti** apre direttamente il selettore file nativo del dispositivo e conserva le liste ricevute separatamente e in sola lettura, così possono essere consultate e ricondivise senza alterare né perdere l’attribuzione del responsabile. Sono accettati anche i precedenti export versione 2. Tutti i dati restano soltanto nel browser/dispositivo.
- In ogni lista della cronologia, anche importata, **Mostra sulla mappa** aggiunge il punto a una vista d’insieme persistente. Le selezioni di liste diverse convivono; **Vedi insieme** le inquadra senza modificare le cronologie e **Nascondi** le azzera. L’opzione **Mostra il mirino in “Vedi insieme”** decide se mantenere visibili mirino e lente: lasciandola spenta la vista resta completamente libera, mentre **Mostra mirino** permette di riattivarli direttamente dalla mappa.
- Due punti visibili, anche appartenenti a liste diverse, possono essere uniti con **Collega** e **Collega qui**. Le linee restano salvate su quel dispositivo, compaiono solo quando entrambi i punti sono visibili e si eliminano dal riepilogo **Linee tra punti** con **Togli**.
- Lo zoom massimo è limitato a 5× rispetto alla vista iniziale, più affidabile sui dispositivi mobili. Il mirino integra una lente 2,35× che ingrandisce in tempo reale la porzione esatta sotto il punto oro.
