...
- In **Mappa e linee**, **Mostra tutti** e **Nessuno** agiscono sulla lista visualizzata, mentre **Nascondi tutti** azzera la selezione globale. I punti di liste diverse convivono nella stessa vista; **Vedi insieme** li inquadra senza modificare le cronologie. L’opzione dedicata decide se mantenere visibile il mirino.
