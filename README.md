...
- Lo zoom massimo è limitato a 5× rispetto alla vista iniziale, più affidabile sui dispositivi mobili. Il pulsante circolare della lente, nella barra superiore accanto a **x/y**, abilita la lente 2,35× del mirino; la scelta resta salvata sul dispositivo. Quando è spenta rimangono il cerchio trasparente e il punto oro, senza ingrandimento.
- Il pulsante **Localizzami** usa, solo su richiesta, la posizione del dispositivo e mostra un punto blu separato dai punti della caccia. Il primo rilevamento centra la mappa; gli aggiornamenti successivi muovono soltanto il punto. La posizione non viene salvata né inserita nelle immagini condivise.
